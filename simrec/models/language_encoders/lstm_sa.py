...
#         lang_feat_mask = make_mask(ques_ix.unsqueeze(2))#[16, 1, 1, 15]
#         # print("lang_feat_mask",lang_feat_mask.shape)
#         lang_feat = self.embedding(ques_ix)#[16, 15, 300]
#         # print("embedding",lang_feat.shape)
#         lang_feat, _ = self.lstm(lang_feat)#[16, 15, 512]
#         # print("lang_feat",lang_feat.shape)
#         for sa in self.sa_list:
#             lang_feat = sa(lang_feat, lang_feat_mask)#[16, 15, 512]
#         # print("lang_feat2",lang_feat.shape)
#         flat_lang_feat = self.att_flat(lang_feat, lang_feat_mask)#[16, 512]
#         # print("flat_lang_feat",flat_lang_feat.shape)
#         return  {
...
class LSTM_SA(nn.Module):
    ...
    def __init__(
        ...
        self.sa_list = nn.ModuleList([SA(hidden_size, num_heads, ffn_size, dropout_rate) for _ in range(depth)])
        self.att_flat=AttFlat(hidden_size, flat_glimpses, dropout_rate)#512,1,0.1
    ...
    def forward(self, ques_ix):
        ...
        for sa in self.sa_list:
            ...
            # print("lang_feat2",lang_feat.shape)
            flat_lang_feats.append(flat_lang_feat)#[16, 512]
            # print("flat_lang_feat",flat_lang_feat.shape)
        return  {
            'flat_lang_feat':flat_lang_feats,
            'lang_feat':lang_feat,
            'lang_feat_mask':lang_feat_mask
        }