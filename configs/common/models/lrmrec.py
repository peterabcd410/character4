...
from simrec.models.lrm_rec import LrmREC
from simrec.models.backbones import CspDarkNet
from simrec.models.heads import REChead,MCNhead
from simrec.models.language_encoders import LSTM_SA
from simrec.layers.fusion_layer import SimpleFusion, MultiScaleFusion, MultiScaleFusion_,GaranAttention,RepBiFPANNeck,TSRMFusion,LFPN

model = LazyCall(LrmREC)(
    ...
    # multi_scale_manner=LazyCall(LFPN)(
    ...
    fusion_manner2=LazyCall(nn.ModuleList)(
        modules = [
